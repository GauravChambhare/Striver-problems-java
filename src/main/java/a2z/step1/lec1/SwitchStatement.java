...
class SwitchStatement {
    static double switchCase(int choice, List<Double> arr) {
        ...
        switch (choice) {
            ...
            case 2:
                if (arr.size() < 2){
                    throw new IllegalArgumentException("ERROR: A rectangle requires exactly 2 dimensions.");
                }
                return arr.get(0) * arr.get(1);
            default:
                throw new IllegalArgumentException("ERROR: Enter valid choice, either 1 or 2.");
        }
    }
/*
